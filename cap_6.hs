...
own_factorial_1 :: Int -> Int
own_factorial_1 n = Prelude.product [1..n]

own_factorial_2 :: Int -> Int
own_factorial_2 0 = 1
own_factorial_2 (n+1) = (n+1) * own_factorial_2 n

facorial_rec :: Int -> Int
facorial_rec 0 = 1
facorial_rec (n) = n * facorial_rec (n-1)
...
own_drop_1 0 xs = xs
own_drop_1 (n+1) [] = []
own_drop_1 (n+1) (_:xs) = own_drop_1 n xs

own_drop_2 :: Int -> [a] -> [a]
own_drop_2 _ [] = []
own_drop_2 n xs@(_:xs')
   | n > 0     = own_drop_2 (n-1) xs'
   | otherwise = xs
...
main = do
    print(own_factorial_1 5)
    print(own_factorial_2 5)
    ...
    print(own_drop_1 4 [1..6])
    print(own_drop_2 4 [1..6])
